...
def train(model, device, train_loader, optimizer, epoch, slim_params, bn_threshold):
    ...
    for i, (inputs_1, inputs_2, inputs_3, labels) in enumerate(train_loader):
        ...
        optimizer.zero_grad()
        outputs, _ = model(inputs_1, inputs_2, inputs_3)
...
def main():
    ...
    model = Net(args.hsi_bands,  args.sar_bands, args.dsm_bands, args.hidden_size, Bottleneck, args.num_parallel,args.num_reslayer, args.num_class, args.bn_threshold).to(device)
